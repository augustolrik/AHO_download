...
- Current state: Download-site updates for all non-technical file types, direct file downloads, and folder ZIP downloads are committed and pushed. A local update now also collapses each folder until the user presses the open-folder button; it awaits commit and push. The public page is live at https://augustolrik.github.io/AHO_download/.
- Blockers: None.
